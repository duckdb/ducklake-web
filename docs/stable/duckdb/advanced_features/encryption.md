...
The generated keys are stored in the catalog, in the `encryption_key` field of the [ducklake_data_file](/docs/stable/specification/catalog/tables#ducklake_data_file) table.
